            ...
            (this, function (t)
            {
                ...
                return O.matches = function (t, e)
                {
                    ...
                    O.fragment = function (t, n, i)
                    {
                        ...
                        o || (t.replace && (t = t.replace(g, "<$1></$2>")), n === e && (n = m.test(t) && RegExp.$1), n in T || (n = "*"), (s = T[n]).innerHTML = "" + t, o = r.each(l.call(s.childNodes), function ()
                                {
                                    s.removeChild(this)
                                }
                                )),
                            ...
                            !function t(r, i, o)
                            {
                                for (n in i)
                                    o && (R(i[n]) || D(i[n])) ? (R(i[n]) && !R(r[n]) && (r[n] = {}
                                        ), D(i[n]) && !D(r[n]) && (r[n] = []), t(r[n], i[n], o)) : i[n] !== e && (r[n] = i[n])
                            }
                            (t, i, r)
                        }
                        ),
                ...
                function (e)
                {
                    ...
                    {
                        if ((e = d(e)).ns)
                            var i = (o = e.ns, new RegExp("(?:^| )" + o.replace(" ", " .* ?") + "(?: |$)"));
                        var o;
                    ...
                    e.fn.triggerHandler = function (t, n)
                    {
                        ...
                        return this.each(function (o, s)
                        {
                            ...
                            {
                                if (i = e.proxy(r), r.isImmediatePropagationStopped())
                                    return !1
                            }
                            )
                        }
                ...
                function (e)
                {
                    ...
                    e.ajax = function (i)
                    {
                        ...
                        var j = b.dataType,
                        T = /\?.+=\?/.test(b.url);
                        if (T && (j = "jsonp"), !1 !== b.cache && (i && !0 === i.cache || "script" != j && "jsonp" != j) || (b.url = x(b.url, "_=" + Date.now())), "jsonp" == j)
                        ...
                        if (P.setRequestHeader = N, P.onreadystatechange = function ()
                        {
                            if (4 == P.readyState)
                            {
                                ...
                                {
                                    if (j = j || ((r = b.mimeType || P.getResponseHeader("content-type")) && (r = r.split(";", 2)[0]), r && (r == l ? "html" : r == c ? "json" : s.test(r) ? "script" : u.test(r) && "xml") || "text"), "arraybuffer" == P.responseType || "blob" == P.responseType)
                                        t = P.response;
                                    else
                                    {
                                        t = P.responseText;
    ...
    "Bb20": [function (require, module, exports)
        {
            ...
            t(function ()
            {
                ...
                for (var m, s, g, b, v = 2e4; v--; )
                    m = void 0, s = void 0, g = void 0, b = void 0, d.push(
                    {
                        x: h(-o.width, o.width),
